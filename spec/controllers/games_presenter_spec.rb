...
describe GamesPresenter do
  attr_reader :presenter, :game, :player1

  before(:each) do
    @player1 = create_player(TicTacToe::VALUES[0])
    @game = MockGame.factory
    @presenter = GamesPresenter.new(@game)
  end

  def create_player(value)
    TicTacToe::WebPlayerFactory.new.human(value)
  end
